...
battle.o : battle.cpp battle.hpp cell.hpp events.hpp graphics.hpp hero.hpp macros.hpp map.hpp timer.hpp unit.hpp
	$(CC) $(CFLAGS) battle.cpp

boot.o : boot.cpp boot.hpp events.hpp graphics.hpp
	$(CC) $(CFLAGS) boot.cpp

cell.o : cell.cpp cell.hpp graphics.hpp macros.hpp unit.hpp
	$(CC) $(CFLAGS) cell.cpp

editor.o : editor.cpp editor.hpp cell.hpp events.hpp macros.hpp map.hpp
	$(CC) $(CFLAGS) editor.cpp

events.o : events.cpp events.hpp macros.hpp
	$(CC) $(CFLAGS) events.cpp

graphics.o : graphics.cpp graphics.hpp image.hpp macros.hpp timer.hpp ttf.hpp
	$(CC) $(CFLAGS) graphics.cpp

hero.o : hero.cpp hero.hpp graphics.hpp macros.hpp unit.hpp
	$(CC) $(CFLAGS) hero.cpp
...
map.o : map.cpp map.hpp cell.hpp events.hpp graphics.hpp macros.hpp timer.hpp unit.hpp
	$(CC) $(CFLAGS) map.cpp
...
mission.o : mission.cpp mission.hpp hero.hpp macros.hpp map.hpp unit.hpp world.hpp
	$(CC) $(CFLAGS) mission.cpp

timer.o : timer.cpp timer.hpp macros.hpp
	$(CC) $(CFLAGS) timer.cpp

ttf.o : ttf.cpp ttf.hpp macros.hpp
	$(CC) $(CFLAGS) ttf.cpp

unit.o : unit.cpp unit.hpp graphics.hpp macros.hpp
	$(CC) $(CFLAGS) unit.cpp

unit_type.o : unit_type.cpp unit.hpp
	$(CC) $(CFLAGS) unit_type.cpp

world.o : world.cpp world.hpp battle.hpp cell.hpp events.hpp hero.hpp macros.hpp map.hpp unit.hpp
	$(CC) $(CFLAGS) world.cpp
